        ...
        if ($requests->count() > 0) {
            ...
            foreach ($requests as $request) {
                ...
                $response .= "<tr>
                                        ...
                                        <td>
                            <a href='#' id='" . $request->item_user . "' class='processRequestButton btn-sm btn-outline-secondary'>" . $request->getStatusRequestAttribute2() . "</a>|<a href='#' id='" . $request->item_user . "'  data-bs-toggle='modal'
